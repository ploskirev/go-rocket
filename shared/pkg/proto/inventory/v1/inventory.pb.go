...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*ListPartsResponse)(nil),     // 3: inventory.v1.ListPartsResponse
	(*Part)(nil),                  // 4: inventory.v1.Part
	(*Dimensions)(nil),            // 5: inventory.v1.Dimensions
	(*Manufacturer)(nil),          // 6: inventory.v1.Manufacturer
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	8,  // 0: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	4,  // 1: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	0,  // 2: inventory.v1.Part.category:type_name -> inventory.v1.Category
	5,  // 3: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	6,  // 4: inventory.v1.Part.manufacturer:type_name -> inventory.v1.Manufacturer
	...
	10, // 7: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
